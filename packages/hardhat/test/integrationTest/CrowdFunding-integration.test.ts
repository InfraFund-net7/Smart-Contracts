...
import { CrowdFunding, SecurityToken, MockUSDC, EnergyToken } from "../../typechain";
...
describe("CrowdFunding Integration Tests", function () {
  ...
  let infraFundWallet: HardhatEthersSigner;
  ...
  const CLAIM_PERIOD = 30 * 24 * 60 * 60; // 30 days for claim period
  ...
  async function createAndSignAgreement(agreementText: string, signer: HardhatEthersSigner) {
    ...
    console.log(`✍️  Signature components: r=${signature.r}, s=${signature.s}, v=${signature.v}`);
  ...
  async function setupFixture() {
    ...
    // Get signers
    [deployer, auditor, generalContractor, client, investor1, investor2, investor3, energyProvider, infraFundWallet] =
      await ethers.getSigners();

    console.log("\n👥 Account roles:");
    console.log(`👤 Deployer: ${await deployer.getAddress()}`);
    console.log(`🔍 Auditor: ${await auditor.getAddress()}`);
    console.log(`🏗️  General Contractor: ${await generalContractor.getAddress()}`);
    ...
    console.log(`⚡ Energy Provider: ${await energyProvider.getAddress()}`);
    console.log(`💼 InfraFund Wallet: ${await infraFundWallet.getAddress()}`);
    ...
    console.log(`\n⏱️  Setting investment period to end at: ${new Date(endInvestmentPeriod * 1000).toLocaleString()}`);
    ...
    crowdFunding = await CrowdFunding.deploy(
      ...
      await infraFundWallet.getAddress(),
      CLAIM_PERIOD
    );
    ...
    console.log("⚙️  Initializing CrowdFunding contract...");
    await crowdFunding.initialize(endInvestmentPeriod, targetAmount, milestoneAmounts, platformFeePercentage);
    ...
    await mockUSDC.mint(await investor1.getAddress(), USDCAmount);
    await mockUSDC.mint(await investor2.getAddress(), USDCAmount);
    await mockUSDC.mint(await investor3.getAddress(), USDCAmount);
    console.log(`💵 Minted ${ethers.formatEther(USDCAmount)} USDC to each investor`);
  ...
  describe("Basic Contract Setup", function () {
    it("should initialize with the correct parameters", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Basic Contract Setup                    ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
      ...
      expect(await crowdFunding.infraFundWallet()).to.equal(await infraFundWallet.getAddress());

      const proposal = await crowdFunding.proposal();
      expect(proposal.targetAmount).to.equal(targetAmount);
      expect(proposal.platformFeePercentage).to.equal(platformFeePercentage);
      console.log(`🎯 Target amount: ${ethers.formatEther(proposal.targetAmount)} ETH`);
      console.log(`💸 Platform fee percentage: ${proposal.platformFeePercentage}%`);
  ...
  describe("Complete Funding Workflow", function () {
    it("should execute the complete crowdfunding workflow successfully", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Complete Crowdfunding Workflow          ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");

      // Step 1: Client pledges security tokens
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ 🔄 STEP 1: Client pledges security tokens           │");
      console.log("└─────────────────────────────────────────────────────┘");
      ...
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ 💼 STEP 2: Investors invest in the project          │");
      console.log("└─────────────────────────────────────────────────────┘");
      ...
      // Verify platform fee was automatically withdrawn
      expect(await crowdFunding.platformFeeWithdrawn()).to.equal(true);
      console.log(`💸 Platform fee withdrawn: ${await crowdFunding.platformFeeWithdrawn()}`);
      
      // Calculate expected platform fee
      const expectedPlatformFee = targetAmount * BigInt(platformFeePercentage) / 100n;
      console.log(`💰 Expected platform fee: ${ethers.formatEther(expectedPlatformFee)} USDC`);
      
      // Check InfraFund wallet balance
      const infraFundBalance = await mockUSDC.balanceOf(await infraFundWallet.getAddress());
      console.log(`💼 InfraFund wallet balance: ${ethers.formatEther(infraFundBalance)} USDC`);
      expect(infraFundBalance).to.equal(expectedPlatformFee);

      // Step 3: Investors claim energy tokens
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ ⚡ STEP 3: Investors claim energy tokens             │");
      console.log("└─────────────────────────────────────────────────────┘");
      ...
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ 📝 STEP 4: General contractor signs agreement       │");
      console.log("└─────────────────────────────────────────────────────┘");
      ...
      console.log("✍️  General contractor signing agreement...");
      ...
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ 🏁 STEP 5: Verify milestones and withdraw funds     │");
      console.log("└─────────────────────────────────────────────────────┘");
      ...
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ 🏛️  STEP 6: Extra fund request, voting, and execution │");
      console.log("└─────────────────────────────────────────────────────┘");

      // Check available funds for extra fund requests
      const availableFunds = await crowdFunding.getAvailableFunds();
      console.log(`💵 Available funds for extra requests: ${ethers.formatEther(availableFunds)} USDC`);

      const proposalHash = ethers.keccak256(ethers.toUtf8Bytes("Extra fund proposal"));
      const extraFundAmount = ethers.parseEther("50"); // Use a smaller amount that should be available
      ...
      console.log("🗳️  Investors voting on extra fund request...");
      ...
      console.log(`⏱️  Fast-forwarding time by ${votingDuration + 1} seconds to end voting period...`);
      await time.increase(votingDuration + 1);

      // Execute the extra fund request
      console.log("🔄 General contractor executing the extra fund request...");
      await crowdFunding.connect(generalContractor).executeExtraFundRequest(0);
      ...
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ 🏁 STEP 7: Complete remaining milestones             │");
      console.log("└─────────────────────────────────────────────────────┘");
      ...
      console.log("\n┌─────────────────────────────────────────────────────┐");
      console.log("│ ⚡ STEP 8: Energy credit redemption                  │");
      console.log("└─────────────────────────────────────────────────────┘");

      // Update energy credit rate
      console.log("⚙️  Owner updating energy credit rate to 2...");
      ...
      console.log("\n⚡ Energy credit redemption details:");
    ...
    it("should not allow investing after investment period ends", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Investment Period Enforcement            ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
      ...
      console.log(`⏱️  Fast-forwarding time by ${investmentPeriod + 1} seconds (past investment period)...`);
      ...
      console.log("⚠️  Investor 1 attempting to invest after period end (should fail)...");
    ...
    it("should allow refund claims if funding fails", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Refund Mechanism                         ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
      ...
      const investorInitialBalance = await mockUSDC.balanceOf(await investor1.getAddress());
      console.log(`💰 Investor 1 initial balance: ${ethers.formatEther(investorInitialBalance)} USDC`);
      console.log(
      ...
      console.log(`⚠️  Funding gap: ${ethers.formatEther(fundingGap)} USDC needed to reach target`);
      console.log(
      ...
      console.log(`⏱️  Fast-forwarding time by ${investmentPeriod + 1} seconds to end investment period...`);
      await time.increase(investmentPeriod + 1);
      ...
      expect(investorBalance).to.equal(investorInitialBalance);
    ...
    it("should respect emergency stops", async function () {
      ...
      console.log("⚠️  Investor 1 attempting to invest during emergency stop (should fail)...");
      await expect(crowdFunding.connect(investor1).invest(investAmount)).to.be.revertedWith(
    ...
    it("should enforce access control", async function () {
      ...
      console.log("⚠️  Investor 1 attempting to call client-only function (should fail)...");
      ...
      console.log("⚠️  Investor 1 attempting to call auditor-only function (should fail)...");
      ...
      console.log("⚠️  Investor 1 attempting to call general contractor-only function (should fail)...");
      ...
      console.log("⚠️  Investor 1 attempting to call energy provider-only function (should fail)...");
      await expect(
    ...
    it("should prevent re-initialization", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Initialization Protection                ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");

      // Attempt to initialize the contract again
      console.log("⚠️  Attempting to initialize the contract a second time (should fail)...");

      const currentTimestamp = (await ethers.provider.getBlock("latest"))!.timestamp;
      const newEndInvestmentPeriod = currentTimestamp + investmentPeriod;

      await expect(
        crowdFunding.initialize(newEndInvestmentPeriod, targetAmount, milestoneAmounts, platformFeePercentage)
    ...
    it("should correctly withdraw platform fee when funding is successful", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Platform Fee Withdrawal                  ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
      ...
      // Complete funding
      console.log("💰 Investors fully funding the project...");
      await mockUSDC.connect(investor1).approve(crowdFundingAddress, targetAmount);
      await crowdFunding.connect(investor1).invest(targetAmount);
      
      // Verify funding is successful
      expect(await crowdFunding.fundingStatus()).to.equal(1); // Successful
      console.log(`✅ Funding status: ${await crowdFunding.fundingStatus()} (Successful)`);

      // Verify platform fee was withdrawn
      expect(await crowdFunding.platformFeeWithdrawn()).to.equal(true);
      console.log(`✅ Platform fee withdrawn: ${await crowdFunding.platformFeeWithdrawn()}`);

      // Calculate expected fee
      const expectedFee = (targetAmount * BigInt(platformFeePercentage)) / 100n;
      console.log(`💰 Expected platform fee (${platformFeePercentage}%): ${ethers.formatEther(expectedFee)} USDC`);

      // Check infra fund wallet balance
      const infraFundBalance = await mockUSDC.balanceOf(await infraFundWallet.getAddress());
      console.log(`💼 InfraFund wallet balance: ${ethers.formatEther(infraFundBalance)} USDC`);
      
      // Verify balance matches expected fee
      expect(infraFundBalance).to.equal(expectedFee);

      console.log("✅ Platform fee withdrawal working correctly");
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ ✅ PLATFORM FEE TEST COMPLETE                         ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
    });

    it("should accumulate energy credits correctly for multiple burns", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Energy Credit Accumulation               ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
      ...
      console.log("⚙️  Setting energy credit rate to 2...");
      await crowdFunding.connect(deployer).setEnergyCreditRate(2);
      ...
      console.log(`\n🔥 Investor 1 burning ${ethers.formatEther(burnAmount2)} ETKN (second burn)...`);
      ...
      console.log("\n✅ Energy credit accumulation working correctly");
    ...
    it("should provide accurate information about available funds", async function () {
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ 🧪 TESTING: Available Funds Calculation              ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
      ...
      // Verify funding is successful
      expect(await crowdFunding.fundingStatus()).to.equal(1);
      console.log(`✅ Funding status: ${await crowdFunding.fundingStatus()} (Successful)`);

      // Calculate expected available funds
      const totalMilestoneAmount = milestoneAmounts.reduce((a, b) => a + b, 0n);
      const platformFee = (targetAmount * BigInt(platformFeePercentage)) / 100n;
      const expectedAvailable = targetAmount - totalMilestoneAmount - platformFee;
      
      console.log(`\n📊 Funds breakdown:`);
      console.log(`💰 Total raised: ${ethers.formatEther(targetAmount)} USDC`);
      console.log(`🏁 Total milestone allocations: ${ethers.formatEther(totalMilestoneAmount)} USDC`);
      console.log(`💸 Platform fee (${platformFeePercentage}%): ${ethers.formatEther(platformFee)} USDC`);
      console.log(`💵 Expected available funds: ${ethers.formatEther(expectedAvailable)} USDC`);

      // Check available funds from contract
      const availableFunds = await crowdFunding.getAvailableFunds();
      console.log(`\n💰 Contract reports available funds: ${ethers.formatEther(availableFunds)} USDC`);
      
      // Verify available funds calculation
      expect(availableFunds).to.equal(expectedAvailable);

      console.log("✅ Available funds calculation is correct");
      console.log("\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
      console.log("┃ ✅ AVAILABLE FUNDS TEST COMPLETE                      ┃");
      console.log("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
    });
  });
...
//       const investAmount = ethers.parseEther("300");
//       const investorInitialBalance = await mockUSDC.balanceOf(await investor1.getAddress());
//       console.log(`investor 1 initial balance: ${investorInitialBalance}`)
//       console.log(
//         `Investor 1 investing ${ethers.formatEther(investAmount)} USDC (deliberately less than target to test refund)...`,
//       );
//       await mockUSDC.connect(investor1).approve(crowdFundingAddress, investAmount);
...
//     it("should correctly withdraw platform fee when funding is successful", async function () {
//       console.log("\n=== TESTING: Platform Fee Withdrawal ===");
...
//     it("should provide accurate information about available funds", async function () {
//       console.log("\n=== TESTING: Available Funds Calculation ===");
...
//       // Check available funds from contract
//       const availableFunds = await crowdFunding.getAvailableFunds();
//       console.log(`Contract reports available funds: ${ethers.formatEther(availableFunds)} USDC`);
