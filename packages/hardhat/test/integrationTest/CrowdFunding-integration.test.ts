...
//     console.log(`infraFundWallet: ${await infraFundWallet.getAddress()}`);
...
//       await expect(crowdFunding.initialize(newEndInvestmentPeriod, targetAmount, milestoneAmounts, platformFeePercentage)).to.be.revertedWith(
//         "Already initialized",
//       );
