...
const checkInvestment: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const utilityAddress = "0x72bb9c7ffbE2Ed234e53bc64862DdA6d9fFF333b";
  const crowdFundingAddress = "0x31c91FD3540b5cE5780AFe47E442814e229BC019";
  const energyAddress = "0xF1478f211F027EBA42ca369ea976F1eB43C6bB53";
