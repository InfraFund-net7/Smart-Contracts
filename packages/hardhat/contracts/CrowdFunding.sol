...
//     Proposal public proposal;
//     uint256 public MAX_VOTING_PERIOD = 7 days;
//     uint256 public MAX_DESCRIPTION_LENGTH = 256; // Limit to 256 characters
...
//         client = _client;
//         fundingStatus = FundingStatus.Active;
//         CLAIM_PERIOD = _Claim_period;
//         MAX_VOTING_PERIOD = _MaxVotingPeriod;
//         initialized = true;// This is to prevent double initialization.
...
//     emit EnergyCreditsClaimed(msg.sender, amount);
// }
